...
public class MsIndicesAndPKReader extends AbstractSearchPathJdbcReader<MsJdbcLoader> implements IMsJdbcReader {
    ...
    protected void processResult(ResultSet res, ISchema schema) throws SQLException, XmlReaderException {
        ...
        if (type == DbObjType.CONSTRAINT) {
            ...
            fillColumns(constrPk, MsXmlReader.readXML(res.getString("cols")), schema.getName(), parent, false, false);
    ...
    private void fillColumns(ISimpleColumnContainer stmt, List<MsXmlReader> cols, String schema, String parent,
