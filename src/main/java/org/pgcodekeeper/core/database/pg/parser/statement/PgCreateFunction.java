 ...
 */
public final class PgCreateFunction extends PgParserAbstract {
     ...
     */
    public PgCreateFunction(Create_function_statementContext ctx, PgDatabase db,
    ...
    private void setConfigParams(Function_actions_commonContext action, PgAbstractFunction function) {
        ...
        if (setOpts.ROLE() != null) {
            ...
            String val = "none".equalsIgnoreCase(role) ? "none" : role;
        ...
        if (scope != null) {
            ...
            par = "timezone".equalsIgnoreCase(par) ? "\"TimeZone\"" : par;
        }
    ...
    private List<Pair<String, ObjectReference>> fillArguments(PgAbstractFunction function) {
        ...
        for (Function_argumentsContext argument : ctx.function_parameters()
            ...
            if (def != null) {
                ...
                db.addAnalysisLauncher(new PgVexAnalysisLauncher(function, def, fileName));
            }
