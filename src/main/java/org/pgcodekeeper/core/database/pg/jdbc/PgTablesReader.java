 ...
 */
public final class PgTablesReader extends PgAbstractSearchPathJdbcReader {
    ...
    protected void processResult(ResultSet res, ISchema schema) throws SQLException {
        ...
        // INHERITS
        String[] inhrelnames = PgJdbcUtils.getColArray(res, "inhrelnames", true);
        if (inhrelnames != null) {
            String[] inhnspnames = PgJdbcUtils.getColArray(res, "inhnspnames");
    ...
    private void fillRegularTable(PgAbstractTable t, ResultSet res) throws SQLException {
        ...
        if (PgSupportedVersion.GP_VERSION_7.isLE(loader.getVersion())) {
            ...
            if ("p".equals(res.getString("relkind"))) {
                ...
                IPgJdbcReader.checkObjectValidity(partitionBy, DbObjType.TABLE, t.getBareName());
    ...
    private void readColumns(ResultSet res, PgAbstractTable t, long ofTypeOid,
        ...
        Long[] colTypeIds = PgJdbcUtils.getColArray(res, "col_type_ids");
        String[] colTypeName = PgJdbcUtils.getColArray(res, "col_type_name");
        Boolean[] colHasDefault = PgJdbcUtils.getColArray(res, "col_has_default");
        ...
        if (PgSupportedVersion.VERSION_16.isLE(loader.getVersion())) {
            ...
            colStatistics = PgJdbcUtils.getColArray(res, "col_statistics");
        }
        ...
        if (loader.isGreenplumDb()) {
            colEncOptions = PgJdbcUtils.getColArray(res, "col_enc_options");
        }
