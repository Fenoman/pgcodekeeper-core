...
/**
 * Fail-closed authorization value for exact cross-loader body reuse.
 */
public record RoutineBodyAuthorization(RoutineBodyProfile profile,
                                       RoutineBodyRepresentation representation,
                                       RoutineFingerprint fingerprint) {

    public RoutineBodyAuthorization {
    ...
    public boolean matches(RoutineBodyAuthorization other) {
        return equals(other);
    }
}
