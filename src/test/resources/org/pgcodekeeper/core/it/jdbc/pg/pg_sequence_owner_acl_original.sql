...
ALTER TABLE pgck_sequence_owner_acl.owner_acl_table OWNER TO pgck_soa_old;
...
ALTER SEQUENCE pgck_sequence_owner_acl.owner_acl_seq OWNER TO pgck_soa_old;

ALTER SEQUENCE pgck_sequence_owner_acl.owner_acl_seq
    OWNED BY pgck_sequence_owner_acl.owner_acl_table.id;

GRANT SELECT ON SEQUENCE pgck_sequence_owner_acl.owner_acl_seq TO pgck_soa_reader;
