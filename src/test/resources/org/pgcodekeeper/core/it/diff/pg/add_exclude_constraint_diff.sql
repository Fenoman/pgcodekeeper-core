...
ALTER TABLE public.testtable
	ADD CONSTRAINT test EXCLUDE USING test (id DESC NULLS LAST WITH =) WITH (fillfactor='10') DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE public.testtable
	ADD CONSTRAINT test3 EXCLUDE ((id > 10) DESC NULLS LAST WITH =) WITH (deduplicate_items) DEFERRABLE INITIALLY DEFERRED;
